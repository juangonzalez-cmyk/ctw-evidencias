...
ALTER TABLE public.tasks
  ADD COLUMN IF NOT EXISTS tipo_entrega text NOT NULL DEFAULT 'contractual';

ALTER TABLE public.tasks
  DROP CONSTRAINT IF EXISTS tasks_tipo_entrega_check;
ALTER TABLE public.tasks
  ADD CONSTRAINT tasks_tipo_entrega_check
  CHECK (tipo_entrega IN ('contractual', 'adicional'));

-- Recreate get_sponsor_report to include tipo_entrega
